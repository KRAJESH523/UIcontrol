...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
        super(context, "MyContactDB", null, 2);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE mycontcct(id int,contact_name text, contact_number text, contact_type text, contact_email text)";
        db.execSQL(query);
    }
    ...
    public void storeData(Contact contact){
        ...
        db.insert("mycontcct",null,values);
    ...
    public Contact getData(){
        ...
        String query="SELECT * FROM mycontcct";
